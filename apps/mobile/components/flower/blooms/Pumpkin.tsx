...
import { PUMPKIN_PALETTE } from '@/lib/flowers/moodPalettes';
...
function PumpkinRipe({
  ...
  return (
    <G>
      ...
      <Path
        d={`M ${fruitCx.toFixed(2)} ${stemBaseY.toFixed(2)} C ${(fruitCx + 5).toFixed(2)} ${(fruitBottom - 8).toFixed(2)} ${(fruitCx + 4).toFixed(2)} ${(fruitCy + 6).toFixed(2)} ${(fruitCx + 1).toFixed(2)} ${(fruitBottom - 3).toFixed(2)}`}
      ...
      />
      <Path
        d={`M ${fruitCx.toFixed(2)} ${stemBaseY.toFixed(2)} C ${(fruitCx - 4).toFixed(2)} ${(fruitBottom - 10).toFixed(2)} ${(fruitCx - 2).toFixed(2)} ${(fruitCy + 4).toFixed(2)} ${fruitCx.toFixed(2)} ${(fruitBottom - 2).toFixed(2)}`}
        stroke={PUMPKIN_PALETTE.stemBrown}
        strokeWidth={1.5}
        fill="none"
        strokeLinecap="round"
      ...
      <Path
        d={`M ${(fruitCx - 2).toFixed(2)} ${(fruitTop + 1).toFixed(2)} C ${(fruitCx - 2.5).toFixed(2)} ${(fruitTop - 5).toFixed(2)} ${(fruitCx + 1.5).toFixed(2)} ${(fruitTop - 7).toFixed(2)} ${(fruitCx + 2).toFixed(2)} ${(fruitTop - 1).toFixed(2)} L ${(fruitCx + 1.2).toFixed(2)} ${(fruitTop + 1.5).toFixed(2)} Z`}
        fill={PUMPKIN_PALETTE.stemBrown}
